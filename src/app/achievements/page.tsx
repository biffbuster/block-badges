...
const allCards = [
  { id: "etherean", name: "The Etherean", description: "Hold at least one ETH.", image: "/cards/etherean (2).png", badge: "/badges/etheran.png", category: "Ethereum", chain: "ethereum", points: 300, glowColor: "#60a5fa", tier: "Intermediate" },
  { id: "gas-guzzler", name: "Gas Guzzler", description: "Spend over 10 ETH in gas on Ethereum mainnet.", image: "/cards/gas_guzzler.png", badge: "/badges/gas_guzzler.png", category: "Ethereum", chain: "ethereum", points: 300, glowColor: "#f97316", tier: "Intermediate" },
  { id: "nft-flipper", name: "NFT Flipper", description: "Bought and sold at least 50 NFTs.", image: "/cards/nft_flipper (2).png", badge: "/badges/nft_flipper.png", category: "NFT", chain: "ethereum", points: 300, glowColor: "#8b5cf6", tier: "Intermediate" },
  { id: "multichain", name: "Multichain Maximalist", description: "Used 5 different blockchains.", image: "/cards/multi-chain.png", badge: "/badges/multichain_madness.png", category: "Multi", chain: "multi", points: 500, glowColor: "#60a5fa", tier: "Hard" },
  { id: "opensea", name: "Opensea VIP", description: "Bought an NFT before 2021.", image: "/cards/opensea (2).png", badge: "/badges/opensea_badge.png", category: "NFT", chain: "ethereum", points: 500, glowColor: "#22d3ee", tier: "Hard" },
  { id: "art-blocks", name: "Fine Art Collector", description: "Hold 3 or more Art Blocks items in your wallet.", image: "/cards/art_blocks.png", badge: "/badges/art_collector.png", category: "NFT", chain: "ethereum", points: 500, glowColor: "#4ade80", tier: "Hard" },
  { id: "liquidated", name: "Liquidated", description: "Get liquidated 1 time(s).", image: "/cards/card_01.png", badge: "/badges/liquidated.png", category: "DeFi", chain: "ethereum", points: 300, glowColor: "#ef4444", tier: "Intermediate" },
  { id: "rookie-predictor", name: "Rookie Predictor", description: "Place one wager on Polymarket.", image: "/cards/card_02.png", badge: "/badges/rookie_predictor.png", category: "DeFi", chain: "ethereum", points: 100, glowColor: "#4ade80", tier: "Beginner" },
  { id: "happy-lending", name: "Happy Lending", description: "Lend at least 1 ETH on Aave (Ethereum mainnet).", image: "/cards/card_03.png", badge: "/badges/happy_lending.png", category: "DeFi", chain: "ethereum", points: 300, glowColor: "#c084fc", tier: "Intermediate" },
  { id: "rug-victim", name: "Rug Victim", description: "Still holding the rugged $EMN (Eminence) token.", image: "/cards/emn_rug.png", badge: "/badges/rug_victi.png", category: "DeFi", chain: "ethereum", points: 300, glowColor: "#3b82f6", tier: "Intermediate" },
  { id: "validator", name: "The Validator", description: "Stake at least 1 ETH for over 365 days.", image: "/cards/eth_steak.png", badge: "/badges/validator.png", category: "Ethereum", chain: "ethereum", points: 300, glowColor: "#60a5fa", tier: "Intermediate" },
  { id: "memecoiner", name: "The Memecoiner", description: "Hold $PEPE, $BOBO, $DOGE, or WIF for over 365 days.", image: "/cards/memecoin.png", badge: "/badges/memecoiner.png", category: "DeFi", chain: "ethereum", points: 500, glowColor: "#e879f9", tier: "Hard" },
  { id: "nft-upper-class", name: "NFT Upper Class", description: "Make $20K profit in one NFT trade.", image: "/cards/nft_20k.png", badge: "/badges/nft_upper_class.png", category: "NFT", chain: "ethereum", points: 1000, glowColor: "#f59e0b", tier: "Legendary" },
  { id: "base-bull", name: "Base Bull", description: "Have at least 100 transactions on the Base chain.", image: "/cards/base_bull.png", badge: "/badges/base_bull.png", category: "Multi", chain: "base", points: 300, glowColor: "#0052FF", tier: "Intermediate" },
  { id: "avax-bull", name: "AVAX Bull", description: "Have at least 100 transactions on Avalanche C-Chain.", image: "/cards/avax_bull.jpg", badge: "/badges/avax_bull.png", category: "Multi", chain: "avalanche", points: 300, glowColor: "#E84142", tier: "Intermediate" },
  { id: "diamond-hands", name: "Diamond Hands", description: "Hold 1 BTC for 3 years minimum.", image: "/cards/diamond_hands.png", badge: "/badges/diamond_hands.png", category: "Ethereum", chain: "bitcoin", points: 800, glowColor: "#e2e8f0", tier: "Veteran" },
  { id: "whale-activity", name: "Whale Activity", description: "Hold at least 100 ETH.", image: "/cards/whale_activity.png", badge: "/badges/whale_activity.png", category: "Ethereum", chain: "ethereum", points: 1000, glowColor: "#38bdf8", tier: "Legendary" },
  { id: "ethereum-villager", name: "Ethereum Villager", description: "Make at least 5 transactions on Ethereum mainnet.", image: "/cards/2.png", badge: "/badges/vallager.png", category: "Ethereum", chain: "ethereum", points: 100, glowColor: "#60a5fa", tier: "Beginner" },
  { id: "the-contributor", name: "The Contributor", description: "Deploy one contract on Ethereum mainnet.", image: "/cards/3.png", badge: "/badges/contributor.png", category: "Ethereum", chain: "ethereum", points: 100, glowColor: "#f59e0b", tier: "Beginner" },
  { id: "sandwichd", name: "Sandwich'd", description: "Get sandwich'd by an MEV bot.", image: "/cards/8.png", badge: "/badges/sandwichd.png", category: "DeFi", chain: "ethereum", points: 100, glowColor: "#84cc16", tier: "Beginner" },
  { id: "data-wrangler", name: "Data Wrangler", description: "Spend at least 25 SXT to run an onchain query.", image: "/cards/9.png", badge: "/badges/data_wrangler.png", category: "Multi", chain: "base", points: 100, glowColor: "#a78bfa", tier: "Beginner" },
  { id: "bullseye", name: "Bullseye", description: "Sold a BAYC 10% from the top.", image: "/cards/10.png", badge: "/badges/bullseye.png", category: "NFT", chain: "ethereum", points: 1000, glowColor: "#3b82f6", tier: "Legendary" },
  { id: "base-builder", name: "Base Builder", description: "Deploy a smart contract on Base mainnet.", image: "/cards/base_builder_card.png", badge: "/badges/base_builder.png", category: "Multi", chain: "base", points: 300, glowColor: "#0052FF", tier: "Intermediate" },
  { id: "squiggler", name: "Squiggler", description: "Hold one Squiggle by Snowfro in your wallet.", image: "/cards/11.png", badge: "/badges/squiggler.png", category: "NFT", chain: "ethereum", points: 800, glowColor: "#ec4899", tier: "Veteran" },
];
        ...
        >
          ...
          <div className="w-16 h-16 flex-shrink-0 relative">
            <Image
              ...
              style={{ filter: `drop-shadow(0 4px 12px ${card.glowColor}30)` }}
            />
          </div>
    ...
    <Link href={`/achievements/card/${card.id}`}>
      ...
      >
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at center, ${card.glowColor}20 0%, transparent 70%)`,
            filter: "blur(20px)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            boxShadow: `0 4px 24px rgba(0,0,0,0.3), 0 0 40px ${card.glowColor}05`,
          }}
        >
          {/* Card art background — barely visible, blurred, faded edges */}
          <div className="absolute inset-0 pointer-events-none z-0">
            ...
            <div
              ...
              style={{
                background: "radial-gradient(ellipse at center, transparent 20%, #060611 75%)",
              }}
            />
            {/* Bottom fade */}
            <div
              className="absolute inset-0"
              style={{
                background: "linear-gradient(to bottom, transparent 30%, #060611 85%)",
              }}
            />
          </div>

          {/* Badge 3D spin container */}
          <div
            className="relative w-[82%] mb-2 z-10"
            style={{
              filter: `drop-shadow(0 16px 32px rgba(0,0,0,0.7)) drop-shadow(0 6px 16px ${card.glowColor}30)`,
              perspective: "800px",
            }}
          >
            <div className="badge-3d-spin relative">
              {/* Front face — badge art */}
              <div className="badge-face relative">
                ...
                <div
                  ...
                  style={{
                    WebkitMaskImage: `url(${card.badge})`,
                    WebkitMaskSize: "contain",
                    WebkitMaskRepeat: "no-repeat",
                    WebkitMaskPosition: "center",
                    maskImage: `url(${card.badge})`,
                    maskSize: "contain",
          ...
          {/* Ground shadow beneath badge */}
          <div
            className="w-[55%] h-3 rounded-full mb-3 z-10"
            style={{
              background: `radial-gradient(ellipse at center, ${card.glowColor}35 0%, transparent 70%)`,
              filter: "blur(6px)",
            }}
          />
          ...
          {/* Points button — glossy with shine */}
          <div
            className="relative z-10 inline-flex items-center gap-2 px-4 py-1.5 rounded-full overflow-hidden cursor-pointer"
            style={{
              background: `linear-gradient(135deg, rgba(251,191,36,0.25) 0%, rgba(245,158,11,0.12) 50%, rgba(251,191,36,0.2) 100%)`,
              border: "1px solid rgba(251,191,36,0.4)",
              boxShadow: "0 2px 12px rgba(251,191,36,0.25), 0 1px 3px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.2)",
            }}
          >
            ...
            <div
              className="absolute inset-0 pointer-events-none"
              style={{
                background: "linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0.04) 40%, transparent 60%)",
                borderRadius: "inherit",
              }}
            />
            <span className="relative text-[11px] font-bold text-amber-300 drop-shadow-[0_0_6px_rgba(251,191,36,0.4)]">
              {card.points} pts
            </span>
          </div>
        </div>
...
export default function DashboardPage() {
  ...
  const filtered = useMemo(() => {
    return allCards.filter((card) => {
      ...
      const matchesTier =
        activeTier === "all" || card.tier === activeTier;
      const matchesChain =
        activeChain === "all" ||
        card.chain === activeChain ||
        card.chain === "multi";
      return matchesSearch && matchesTier && matchesChain;
    });
  }, [search, activeTier, activeChain]);
  ...
  return (
    <DashboardLayout>
          ...
          {/* Signed in but wrong chain */}
          {authenticated && isConnected && !onCorrectChain && (
            <div className="flex flex-col items-center gap-6 py-32">
            ...
            <>
              ...
              >
                <div className="flex items-center gap-2 flex-wrap">
                  {(["all", "Beginner", "Intermediate", "Hard", "Veteran", "Legendary"] as const).map((tier) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className="w-1.5 h-1.5 rounded-full"
                          style={{
                            background: isActive ? t.color : "#52525b",
