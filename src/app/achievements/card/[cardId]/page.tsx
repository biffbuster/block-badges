...
export default function CardDetailPage() {
  ...
  return (
    <DashboardLayout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(300px,500px)_1fr] xl:grid-cols-[580px_1fr] gap-8 sm:gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              {/* Title */}
              <h1 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white tracking-tight leading-tight mt-5">
                {card.name}
              </h1>
